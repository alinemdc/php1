...
//1 ao 9:
    ...
    $professor1 = new ProfessorFixo("José", "35", "12345", 3000);
    $professor2 = new ProfessorHorista("Maria", "29", "54321", 100, 50);
...
$usuario1 = new Usuario("aline", "123");

echo $usuario1->getLogin();
echo $usuario1->getSenha();
$usuario1->validarSenha("687");
